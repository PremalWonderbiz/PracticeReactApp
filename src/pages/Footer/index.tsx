        ...
        <div className='p-15 pb-2 bg-black text-white'>
            <div className='flex '>
                ...
                <ul className='flex gap-3 ml-auto'>
                    <li>
                        <a href="#">
                            <svg className="w-6 h-6 text-white hover:text-rose-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="#">
                            <svg className="w-6 h-6 text-white hover:text-rose-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className='flex mt-5 gap-10 '>
                ...
                <div className='px-4'>
                    <ul className='text-lg'>
                        ...
                        <a href="#" className='hover:text-rose-500'><li>SERVICES</li></a>
                ...
                <ul className='text-lg'>
                    ...
                    <a href="#" className='hover:text-rose-500'><li>TRAINS</li></a>
                    <a href="#" className='hover:text-rose-500'><li>FLIGHTS</li></a>
                    <a href="#" className='hover:text-rose-500'><li>EVENTS</li></a>
                </ul>
                </div>
            </div>
